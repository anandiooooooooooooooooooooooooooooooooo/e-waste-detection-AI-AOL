...
const DUMMY_IMAGE_URL = "/demo_image_1.png";
  ...
  const renderLoading = () => (
    <div className="flex flex-col items-center justify-center min-h-[60vh] animate-fade-up">
      <div className="relative w-32 h-32 mb-12">
        <div
          className="absolute inset-0 rounded-full border-2 border-transparent border-t-teal-500 border-r-teal-500 animate-spin"
                    ...
                    {previewUrl ? (
                      ...
                      <>
                        <div className="relative flex py-2 items-center">
                          ...
                          <span className="flex-shrink-0 mx-4 text-[var(--text-secondary)] text-xs uppercase tracking-wider">
                            Or try demo
                          </span>
                          <div className="flex-grow border-t border-black/10"></div>
                        </div>

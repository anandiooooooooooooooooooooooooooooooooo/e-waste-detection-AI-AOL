      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-12 space-y-16 pt-32">
        ...
        <section className="glass-panel p-8 rounded-2xl animate-fade-up" style={{ animationDelay: '100ms' }}>
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
                <span className="font-bold text-white">e-nfo</span> is designed to tackle the growing problem of global electronic waste. By leveraging state-of-the-art Computer Vision and Generative AI, this application empowers users to correctly identify, value, and recycle their old electronics.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                    ...
                    <h3 className="font-bold mb-1">Detection</h3>
                    <p className="text-xs text-gray-400">YOLOv8 instantly identifies electronic components.</p>
                </div>
                <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                    ...
                    <p className="text-xs text-gray-400">Gemini AI / Mock Engine values materials.</p>
                </div>
                <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                    <div className="w-10 h-10 rounded-lg bg-green-500/20 text-green-400 flex items-center justify-center mb-3">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    </div>
                    <h3 className="font-bold mb-1">Action</h3>
                    <p className="text-xs text-gray-400">Finds nearest recycling centers via Maps.</p>
                </div>
            </div>
        </section>
        ...
        <section className="space-y-6 animate-fade-up" style={{ animationDelay: '200ms' }}>
            <h2 className="text-2xl font-bold text-cyan-300">Tech Stack</h2>
            <div className="glass-panel p-6 rounded-2xl">
                <div className="space-y-4">
                    <div className="flex items-start gap-4">
                        <span className="px-2 py-1 bg-yellow-500/10 text-yellow-400 rounded text-xs font-mono border border-yellow-500/20 shrink-0">Frontend</span>
                        <div>
                            <p className="font-bold text-white">React + Tailwind CSS</p>
                    ...
                    <div className="flex items-start gap-4">
                        <span className="px-2 py-1 bg-blue-500/10 text-blue-400 rounded text-xs font-mono border border-blue-500/20 shrink-0">Backend</span>
                        <div>
                            <p className="font-bold text-white">Flask (Python)</p>
                            <p className="text-sm text-gray-400 mt-1">
                    ...
                    <div className="w-full h-[1px] bg-white/5"></div>
                    <div className="flex items-start gap-4">
                        <span className="px-2 py-1 bg-purple-500/10 text-purple-400 rounded text-xs font-mono border border-purple-500/20 shrink-0">AI Models</span>
                        <div>
                            <p className="font-bold text-white">YOLOv8 + Gemini / Mock Engine</p>
                            <p className="text-sm text-gray-400 mt-1">
        ...
        <section className="space-y-6 animate-fade-up" style={{ animationDelay: '300ms' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="glass-panel p-6 rounded-2xl hover:bg-white/5 transition-colors">
                    <h3 className="text-xl font-bold text-white mb-2">Real-World Valuation</h3>
                ...
                <div className="glass-panel p-6 rounded-2xl hover:bg-white/5 transition-colors">
                    <h3 className="text-xl font-bold text-white mb-2">Smart Geolocation</h3>
                    <p className="text-sm text-gray-400">
